         ...
         <p className="mt-6 text-gray-300 max-w-lg text-[15px] md:text-[16px] leading-relaxed mr-44">
           Make the heroes,  earn rewards, <br /> and join the adventure
            ...
            <div className="mt-8 flex flex-row items-center gap-3">
              {/* App Store */}
              <a href="#" className="inline-flex items-center justify-center px-2 py-2">
                <img src="/apple.png" alt="App Store" className="h-14 md:h-16 lg:h-[72px] w-auto object-contain" />
              </a>

              {/* Google Play */}
              <a href="#" className="inline-flex items-center justify-center px-2 py-2">
                <img src="/google.png" alt="Google Play" className="h-14 md:h-16 lg:h-[72px] w-auto object-contain" />
              </a>
            </div>
